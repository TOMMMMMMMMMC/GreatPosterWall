export default {
  ...
  screenshot_comparison: {
    help: `
            ...
            You can also use the arrow keys to navigate: up and down jumps between rows; left and right toggles comparison sides. <br/>
            Comparison sides can also toggled by the number keys (1-9). <br/>
            Click anywhere or press Escape to close the comparison.
        `,
  },
  ...
  upload: {
    ...
    desc_img_3_png: `At least three PNG screenshots are required, see <a href="https://greatposterwall.com/wiki.php?action=article&id=51" target="_blank">help</a>.`,
    desc_img_hosts: `Please use image hosts that are recommended by Upload Rule <a href="https://greatposterwall.com/rules.php?p=upload#r2.2.1" target="_blank">2.2.1</a>.`,
  },
