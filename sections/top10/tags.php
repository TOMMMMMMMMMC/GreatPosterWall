...
View::show_header(Lang::get('top10', 'top_10_tags'));
?>
<div class="thin">
    <div class="header">
        <h2><?= Lang::get('top10', 'top_10_tags') ?></h2>
    ...
    ?>
        ...
        <div class="table_container border">
            <table class="border top10_tags_tables">
                <tr class="colhead">
                    <td class="center"><?= Lang::get('top10', 'rank') ?></td>
                    <td><?= Lang::get('top10', 'tag') ?></td>
                    <td style="text-align: right;"><?= Lang::get('top10', 'uses') ?></td>
                    <? if ($ShowVotes) {   ?>
                        <td style="text-align: right;"><?= Lang::get('top10', 'pos_votes') ?></td>
                        <td style="text-align: right;"><?= Lang::get('top10', 'neg_votes') ?></td>
                    <?  }   ?>
                </tr>
                <?
                ...
                if (empty($Details)) {
                    echo '
		<tr class="rowb">
			<td colspan="9" class="center">' . Lang::get('top10', 'found_no_tags_matching_the_criteria') . '</td>
		</tr>
		</table></div>';
                    return;
                }
