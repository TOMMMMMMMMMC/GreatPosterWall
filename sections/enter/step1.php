<?
View::show_header(Lang::get('register', 'register'));
            ...
            <table class="layout" cellpadding="2" cellspacing="1" border="0" align="center">
                ...
                <tr valign="top">
                    ...
                    <td align="left">
                        ...
                        <label for="readrules"><?= Lang::get('register', 'readrules') ?></label>
                    </td>
                </tr>
                <tr valign="top">
                    <td></td>
                    <td align="left">
                        ...
                        <label for="readwiki"><?= Lang::get('register', 'readwiki') ?></label>
                    </td>
                </tr>
                <tr valign="top">
                    <td></td>
                    <td align="left">
                        ...
                        <label for="agereq"><?= Lang::get('register', 'agereq') ?></label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="right"><input type="submit" name="submit" value="<?= Lang::get('register', 'register') ?>" class="submit" /></td>
                </tr>
            </table>
        <? } else { ?>
