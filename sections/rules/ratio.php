<?
//Include the header
View::show_header(Lang::get('rules', 'ratio_title'));
?>
<div class="thin">
    <? include('jump.php'); ?>
    <div class="header">
    ...
    <div class="box pad rule_summary">
        ...
        <div style="text-align: center;">
            ...
            <div class="table_container border">
                <table class="ratio_table">
                    <tr class="colhead">
                        <td class="tooltip" title="<?= Lang::get('rules', 'ratio_dl_title') ?>"><?= Lang::get('rules', 'ratio_dl') ?></td>
                        <td><?= Lang::get('rules', 'ratio_re_0') ?></td>
                        <td><?= Lang::get('rules', 'ratio_re_100') ?></td>
                    </tr>
        ...
        <ul>
            ...
            <li>
                ...
                <br />
                <div style="text-align: center;">
                    <img style="vertical-align: middle;" src="https://greatposterwall.com/static/styles/public/images/chart.png" alt="required ratio = (maximum required ratio) * (1 - (seeding / snatched))" />
                </div>
                <br />
                <br />
                <ul>
