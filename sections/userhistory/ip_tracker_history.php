...
View::show_header(Lang::get('userhistory', 'tracker_ip_address_history_for_before') . "$Username" . Lang::get('userhistory', 'tracker_ip_address_history_for_after'));
?>
...
<div class="thin">
    <div class="header">
        <h2><?= Lang::get('userhistory', 'tracker_ip_address_history_for_before') ?><a href="user.php?id=<?= $UserID ?>"><?= $Username ?></a><?= Lang::get('userhistory', 'tracker_ip_address_history_for_after') ?></h2>
    </div>
            ...
            ?>
                <tr class="rowa">
                    <td>
                        ...
                        <a href="http://whatismyipaddress.com/ip/<?= display_str($IP) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search_wimia_com') ?>">WI</a>
                    </td>
