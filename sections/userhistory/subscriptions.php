...
View::show_header(Lang::get('userhistory', 'subscriptions'), 'subscriptions,comments,bbcode');
...
<div class="thin">
    <div class="header">
        <h2><?= Lang::get('userhistory', 'with_unread_posts_before') ?><?= Lang::get('userhistory', 'subscriptions') ?><?= $ShowUnread ? Lang::get('userhistory', 'with_unread_posts_after') . ($NumResults ? Lang::get('userhistory', 'left_bracket') . $NumResults . Lang::get('userhistory', 'new_right_bracket') : '') : '' ?></h2>
