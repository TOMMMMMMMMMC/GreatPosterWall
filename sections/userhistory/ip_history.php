...
View::show_header(Lang::get('userhistory', 'ip_address_history_for_before') . "$UserInfo[Username]" . Lang::get('userhistory', 'ip_address_history_for_after'));
?>
...
<div class="thin">
    <div class="header">
        <h2><?= Lang::get('userhistory', 'ip_address_history_for_before') ?><a href="user.php?id=<?= $UserID ?>"><?= $UserInfo['Username'] ?></a><?= Lang::get('userhistory', 'ip_address_history_for_after') ?></h2>
        <div class="linkbox">
            <?
            if ($UsersOnly) { ?>
    ...
    <table>
        <tr class="colhead">
            <td><?= Lang::get('userhistory', 'ip_address_search') ?></td>
        </tr>
    ...
    <div class="table_container border">
        <table id="iphistory">
            <tr class="colhead">
                <td><?= Lang::get('userhistory', 'ip_address') ?></td>
                <td><?= Lang::get('userhistory', 'started') ?> <a href="#" onclick="$('#iphistory .reltime').gtoggle(); $('#iphistory .abstime').gtoggle(); return false;" class="brackets"><?= Lang::get('global', 'toggle') ?></a></td>
                <td><?= Lang::get('userhistory', 'ended') ?></td>
                <td class="hidden"><?= Lang::get('userhistory', 'ended') ?></td>
