...
View::show_header(Lang::get('userhistory', 'email_history_for_before') . "$Username" . Lang::get('userhistory', 'email_history_for_after'));
...
<div class="thin">
    <div class="header">
        <h2><?= Lang::get('userhistory', 'email_history_for_before') ?><a href="user.php?id=<?= $UserID ?>"><?= $Username ?></a><?= Lang::get('userhistory', 'email_history_for_after') ?></h2>
    ...
    <div class="table_container border">
        <table width="100%" id="email_history_table">
            <tr class="colhead">
                <td><?= Lang::get('userhistory', 'current_email') ?></td>
                <td><?= Lang::get('userhistory', 'start') ?></td>
                <td><?= Lang::get('userhistory', 'end') ?></td>
                <td><?= Lang::get('userhistory', 'current_ip') ?> <a href="userhistory.php?action=ips&amp;userid=<?= $UserID ?>" class="brackets">H</a></td>
                <td><?= Lang::get('userhistory', 'set_from_ip') ?></td>
            </tr>
            <tr class="rowa">
            ...
            if ($Old) {
                ?>
                <tr class="colhead">
                    <td><?= Lang::get('userhistory', 'old_emails') ?></td>
                    <td><?= Lang::get('userhistory', 'start') ?></td>
                    <td><?= Lang::get('userhistory', 'end') ?></td>
                    <td><?= Lang::get('userhistory', 'elapsed') ?></td>
                    <td><?= Lang::get('userhistory', 'set_from_ip') ?></td>
                </tr>
                <?
                $j = 0;
                ...
                ?>
                    ...
                    <tr class="rowa">
                        ...
                        <td>
                            ...
                            <a href="user.php?action=search&amp;ip_history=on&amp;ip=<?= display_str($Record['IP']) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search') ?>">S</a>
                            <a href="http://whatismyipaddress.com/ip/<?= display_str($Record['IP']) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search_wimia_com') ?>">WI</a>
                            <br />
            ...
            ?>
            <tr class="colhead">
                <td><?= Lang::get('userhistory', 'invite_email') ?></td>
                <td><?= Lang::get('userhistory', 'start') ?></td>
                <td><?= Lang::get('userhistory', 'end') ?></td>
                <td><?= Lang::get('userhistory', 'age_of_account') ?></td>
                <td><?= Lang::get('userhistory', 'registration_ip_address') ?></td>
            </tr>
            <?
            ...
            ?>
                        <tr class="rowb hidden" id="matches_invite">
                            ...
                            <td>
                                <?= display_str($Match['IP']) ?>
                                (<?= Tools::get_country_code_by_ajax($Match['IP']) ?>)
                                <a href="user.php?action=search&amp;ip_history=on&amp;ip=<?= display_str($Match['IP']) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search') ?>">S</a>
                                <a href="http://whatismyipaddress.com/ip/<?= display_str($Match['IP']) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search_wimia_com') ?>">WI</a>
                                <br />
                                <?= Tools::get_host_by_ajax($Match['IP']) ?>
                            </td>
                        </tr>
            ...
            <tr class="rowa">
                ...
                <td><?= Lang::get('userhistory', 'never') ?></td>
                ...
                <td>
                    ...
                    <a href="user.php?action=search&amp;ip_history=on&amp;ip=<?= display_str($Invite['IP']) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search') ?>">S</a>
                    <a href="http://whatismyipaddress.com/ip/<?= display_str($Invite['IP']) ?>" class="brackets tooltip" title="<?= Lang::get('userhistory', 'search_wimia_com') ?>">WI</a>
                    <br />
