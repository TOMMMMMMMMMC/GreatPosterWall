...
View::show_header(Lang::get('reports', 'other_reports_stats'));

?>
<div class="header">
    <h2><?= Lang::get('reports', 'other_reports_stats') ?></h2>
    <div class="linkbox">
...
<div class="thin float_clear" id="other_reports_stats_details">
	...
	ORDER BY Reports DESC");
        ...
        ?>
            ...
            <table class="box border">
                <tr class="colhead">
                    <td class="colhead_dark"><?= Lang::get('reports', 'username') ?></td>
                    <td class="colhead_dark number_column"><?= Lang::get('reports', 'reports') ?></td>
                </tr>
                <?
    ...
    <div class="two_columns pad">
        ...
        <table class="box border">
            <tr class="colhead">
                <td class="colhead_dark number_column"><?= Lang::get('reports', 'place') ?></td>
                <td class="colhead_dark"><?= Lang::get('reports', 'username') ?></td>
                <td class="colhead_dark number_column"><?= Lang::get('reports', 'trashed') ?></td>
            </tr>
            <?
            $i = 1;
            foreach ($Results as $Result) {
