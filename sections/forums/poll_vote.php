...
?>
    <span class="error"><?= Lang::get('forums', 'please_select_an_option') ?></span><br />
...
?>
    ...
    <strong><?= Lang::get('forums', 'votes') ?>:</strong> <?= number_format($TotalVotes) ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><?= Lang::get('forums', 'voters') ?>:</strong> <?= $PeopleCount ?>
<?
}
