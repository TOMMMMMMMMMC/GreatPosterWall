...
?>
    <div class="thin">
        <div class="header">
            <h2><?= Lang::get('torrents', 'torrent_group_id_change_confirmation') ?></h2>
        </div>
        <div class="box pad">
            <form class="confirm_form" name="torrent_group" action="torrents.php" method="post">
                ...
                <ul>
                    <li><a href="torrents.php?id=<?= $OldGroupID ?>"><?= Torrents::torrent_group_name($OldGroup, true) ?></a></li>
                </ul>
                <h3><?= Lang::get('torrents', 'into_the_group') ?>:</h3>
                <ul>
                    <li><a href="torrents.php?id=<?= $GroupID ?>"><?= Torrents::torrent_group_name($NewGroup, true) ?></a></li>
                </ul>
