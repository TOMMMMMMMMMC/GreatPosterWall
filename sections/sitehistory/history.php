...
View::show_header(Lang::get('sitehistory', 'site_history'));
?>
<div class="header">
    <h2><a href="sitehistory.php"><?= Lang::get('sitehistory', 'site_history') ?></a> <?= $Month && $Year ? date("- F, Y", mktime(0, 0, 0, $Month, 1, $Year)) : '' ?></h2>
    <?
