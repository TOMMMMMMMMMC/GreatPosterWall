...
if (isset($_POST['p_uploads_l'])) {
    ...
    $_POST['p_perfectwavs_l'] = 'on';
    $_POST['p_perfectwavs_c'] = 'on';
    $_POST['p_lossless_l'] = 'on';
    $_POST['p_lossless_c'] = 'on';
...
$SimpleSelects = array('torrentcomments', 'collages', 'collagecontribs', 'uploads', 'uniquegroups', 'perfectwavs', 'perfectflacs', 'seeding', 'leeching', 'snatched', 'lossless', 'originals');
