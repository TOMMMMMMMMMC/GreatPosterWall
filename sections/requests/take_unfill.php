...
if ($UserID !== $LoggedUser['ID']) {
	...
	Misc::send_pm($UserID, 0, Lang::get('inbox', 'request_created_unfilled', $ToUserLang), Lang::get('inbox', 'the_request_url', $ToUserLang) . site_url() . "requests.php?action=view&amp;id=$RequestID]$FullName" . Lang::get('inbox', 'url_was_unfilled_by_url', $ToUserLang) . site_url() . 'user.php?id=' . $LoggedUser['ID'] . ']' . $LoggedUser['Username'] . Lang::get('inbox', 'url_for_the_reason_quote', $ToUserLang) . $_POST['reason'] . '[/quote]');
}
