                ...
                <tr class="torrent torrent_row<?= $Torrents[$FlacID]['IsSnatched'] ? ' snatched_torrent' : '' ?>">
                    <td>
                        <span class="torrent_links_block">
                            <a href="torrents.php?action=download&amp;id=<?= $FlacID ?>&amp;authkey=<?= $LoggedUser['AuthKey'] ?>&amp;torrent_pass=<?= $LoggedUser['torrent_pass'] ?>" title="<?= Lang::get('global', 'download') ?>" class="brackets tooltip">DL</a>
                        </span>
                        <?= $DisplayName ?>
