...
<div class="thin" id="donate_information">
    ...
    <h2 class="donation_info_title"><?= Lang::get('donate', 'why_donate') ?></h2>
    ...
    <div class="box pad donation_info">
    <h2 class="donation_info_title"><?= Lang::get('donate', 'what_will_receive') ?></h2>
    ...
    <div class="box pad donation_info">
    <h2 class="donation_info_title"><?= Lang::get('donate', 'what_wont_receive') ?></h2>
        <?= Lang::get('donate', 'donation_info_12') ?>
    </div>
    
    <div class="box pad donation_info">
    <h2 class="donation_info_title"><?= Lang::get('donate', 'how_to_donate') ?></h2>
        <?= Lang::get('donate', 'donation_info_5') ?>
        <br /><br />
        <a href="donate.php?action=step2"><button><?= Lang::get('donate', 'want_donate') ?></button></a>
    </div>
