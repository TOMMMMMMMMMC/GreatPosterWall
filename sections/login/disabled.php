<?
View::show_header(Lang::get('login', 'disabled'));
...
?>
    ...
    <form action="" method="POST">
        <input type="email" class="inputtext" placeholder="<?= Lang::get('login', 'email_address_placeholder') ?>" name="email" required /> <input type="submit" value="Submit" />
