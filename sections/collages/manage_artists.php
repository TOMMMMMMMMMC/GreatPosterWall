    ...
    <table id="manage_collage_table">
        <thead>
            <tr class="colhead">
                ...
                <th style="text-align: left;" data-sorter="ignoreArticles"><span><?= Lang::get('global', 'artist') ?></span></th>
                <th style="width: 7%;" data-sorter="ignoreArticles"><span><?= Lang::get('collages', 'adder') ?></span></th>
                <th style="width: 7%; text-align: right;" class="nobr" data-sorter="false"><span><abbr class="tooltip" title="<?= Lang::get('collages', 'tweak_title') ?>"><?= Lang::get('collages', 'tweak') ?></abbr></span></th>
            </tr>
        </thead>
        <tbody>
            <?
