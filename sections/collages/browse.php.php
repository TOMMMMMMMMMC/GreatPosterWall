                        ...
                        <td>
                            <select name="order_by" class="ft_order_by">
                                <? foreach ($OrderVals as $Cur) { ?>
                                    <option value="<?= $Cur ?>" <? if (isset($_GET['order_by']) && $_GET['order_by'] === $Cur || (!isset($_GET['order_by']) && $Cur === 'Time')) {
                            ...
                            <select name="order_way" class="ft_order_way">
                                <? foreach ($WayVals as $Cur) { ?>
                                    <option value="<?= $Cur ?>" <? if (isset($_GET['order_way']) && $_GET['order_way'] === $Cur || (!isset($_GET['order_way']) && $Cur === 'Descending')) {
                                                                    echo ' selected="selected"';
                                                                } ?>><?= $Cur ?></option>
                                <?      } ?>
                            </select>
