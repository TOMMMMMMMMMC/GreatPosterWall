...
// Start printing
View::show_header(Lang::get('collages', 'comments_for_collage_before') . "$Name" . Lang::get('collages', 'comments_for_collage_after'), 'comments,bbcode,subscriptions');
?>
<div class="thin">
    <div class="header">
        <h2>
            <a href="collages.php"><?= Lang::get('collages', 'collages') ?></a> &gt;
