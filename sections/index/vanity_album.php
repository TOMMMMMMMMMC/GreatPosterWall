...
?>
    <div class="box">
        <div class="head colhead_dark"><strong><?= Lang::get('index', 'vh_album') ?></strong> <a href="forums.php?action=viewthread&amp;threadid=<?= $FeaturedAlbum['ThreadID'] ?>">[<?= Lang::get('index', 'discuss') ?>]</a></div>
