    ...
    <div id="commonresponses" class="center">
        ...
        <div id="response_new" class="box">
            <form class="send_form" name="response" id="response_form_0" action="">
                <div class="head">
                    <strong>Name:</strong>
                    <input onfocus="if (this.value == 'New name') { this.value = ''; }" onblur="if (this.value == '') { this.value = 'New name'; }" type="text" id="response_name_0" size="87" value="New name" />
                </div>
                <div class="pad">
                    <textarea onfocus="if (this.value == 'New message') { this.value = ''; }" onblur="if (this.value == '') { this.value = 'New message'; }" rows="10" cols="87" id="response_message_0">New message</textarea>
                    <br />
