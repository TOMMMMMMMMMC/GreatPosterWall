    ...
    <form class="search_form" name="donation_log" action="" method="get">
        ...
        <table cellpadding="6" cellspacing="1" border="0" class="layout border" width="100%">
            <tr>
                ...
                <td>
                    <input type="search" name="username" size="60" value="<? if (!empty($_GET['username'])) {
            ...
            <tr>
                ...
                <td>
                    <input type="search" name="email" size="60" value="<? if (!empty($_GET['email'])) {
            ...
            <tr>
                ...
                <td>
                    <input type="search" name="source" size="60" value="<? if (!empty($_GET['source'])) {
