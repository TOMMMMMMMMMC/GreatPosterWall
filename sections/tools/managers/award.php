...
View::show_header(Lang::get('tools', 'work_statistical_graph'));
...
<div id="salary-table">
    <div id="table-head-left">
        ...
        foreach ($AwardDatas as $data) {
            ...
            $headLeftUsers = "";
            $rowspan = 0;
            if ($data['GroupName'] == 'Developers') continue;
            ...
            if (!$first) {
                $GroupNameMap = ['Moderator' => 'Mod', 'Torrent Moderator' => 'TM', 'Forum Moderator' => 'FM', 'Torrent Inspector' => 'TI', 'First Line Support' => 'FLS', 'Interviewer' => 'IN', 'Translators' => 'TL', 'Senior Moderator' => 'SM', 'Developers' => 'Dev', 'Administrator' => 'AD'];
    ...
    <div id="table-right-scroll">
        ...
        <div id="table-content" style="grid-template-columns: repeat(15, 1fr);">
            ...
            ?>
                        ...
                        <div class="<?= $DivClassName ?> col-tail" title="<?= $Gear[$User['Gear']] ?>"><strong><?= $User['Salary'] ?></strong></div>
            <?
                    }
                }
            }
