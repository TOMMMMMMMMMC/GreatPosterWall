...
<div class="thin">
    ...
    if ($DB->has_results()) {
    ?>
        <table width="100%" id="user_permission_entry">
            <tr class="colhead">
                <td><?= Lang::get('tools', 'name') ?></td>
                <td><?= Lang::get('tools', 'level') ?></td>
                <td><?= Lang::get('tools', 'user_count') ?></td>
                <td class="center"><?= Lang::get('tools', 'actions') ?></td>
            </tr>
            ...
            ?>
                <tr>
                    ...
                    <td class="center">
                        ...
                        &nbsp;
                        <a href="#" onclick="return confirmDelete(<?= $ID ?>);" class="brackets float_right"><?= Lang::get('tools', 'remove') ?></a>
                    </td>
                </tr>
            <?  } ?>
        </table>
