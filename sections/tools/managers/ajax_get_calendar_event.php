...
<form id="event_form" name="event_form" method="post" action="">
    ...
    <table class="event_form_table">
        ...
        <tr>
            ...
            <td>
                <input type="date" id="start_date" name="start_date" class="required" <? if ($Event) { ?> value="<?= date('Y-m-d', strtotime($Event['StartDate'])) ?>" />
            <?  } else { ?>
                value="<?= $StartDate ?>" />
            <?  } ?>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="date" id="end_date" name="end_date" class="required" <? if ($Event) { ?> value="<?= date('Y-m-d', strtotime($Event['EndDate'])) ?>" />
            <?  } else { ?>
                value="<?= $EndDate ?>" />
            <?  } ?>
            </td>
