...
?>
<div class="header">
    <h2><?= Lang::get('tools', 'h2_official_tags_manager') ?></h2>
</div>
<div style="text-align: center;">
        ...
        <form class="manage_form" name="tags" method="post" action="">
            ...
            <table class="tags_table layout">
                <tr class="colhead_dark">
                    <td style="font-weight: bold; text-align: center;"><?= Lang::get('tools', 'remove') ?></td>
                    <td style="font-weight: bold;"><?= Lang::get('tools', 'tag') ?></td>
                    <td style="font-weight: bold;"><?= Lang::get('tools', 'uses') ?></td>
                    <td>&nbsp;&nbsp;&nbsp;</td>
                    <td style="font-weight: bold; text-align: center;"><?= Lang::get('tools', 'remove') ?></td>
                    <td style="font-weight: bold;"><?= Lang::get('tools', 'tag') ?></td>
                    <td style="font-weight: bold;"><?= Lang::get('tools', 'uses') ?></td>
	...
	ORDER BY Name ASC");
                ...
                <tr class="<?= (($i % 2) ? 'rowa' : 'rowb') ?>">
                    <td colspan="11">
                        <label for="newtag"><?= Lang::get('tools', 'new_official_tag') ?>: </label><input type="text" name="newtag" />
                    </td>
                </tr>
