...
View::show_header(Lang::get('tools', 'add_bonus_sitewide'));

?>
<div class="header">
    <h2><?= Lang::get('tools', 'add_bonus_points_to_all_users') ?></h2>
</div>
<div class="box pad" style="margin-left: auto; margin-right: auto; text-align: center; max-width: 40%;">
    ...
    <form class="add_form" name="fltokens" action="" method="post">
        ...
        <?= Lang::get('tools', 'points_to_add') ?>: <input type="text" name="num_points" size="10" style="text-align: right;" /><br /><br />
