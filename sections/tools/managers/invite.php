...
?>
<div class="header">
    <h2><?= Lang::get('tools', 'add_invites_to_users') ?></h2>
</div>
<script>
    function timed() {
...
<div class="box pad" style="margin-left: auto; margin-right: auto; text-align: center; max-width: 40%;">
    ...
    <form class="add_form" name="invites" method="post">
        ...
        <br>
        <input id="userid" type="number" name="userid" size="5" style="text-align: right;" value="0" min="0" disabled />
        <br><br>
        <label for="numinvite"><?= Lang::get('tools', 'invites') ?>: </label><br>
        <input id="numinvite" type="number" name="numinvite" size="5" style="text-align: right;" value="0" min="0" />
        <br><br>
        <input type="checkbox" id="time" onclick="timed()" />
        <label for="time"><?= Lang::get('tools', 'period_of_validity') ?></label>
        <br>
        <input type="number" name="datetime" id="datetime" disabled><br><?= Lang::get('tools', 'hours') ?>

        <br><br>
        <input type="submit" name="addinvite" value="Add invites" />
    </form>
</div>
<?
