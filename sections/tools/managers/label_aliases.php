...
View::show_header(Lang::get('tools', 'label_aliases'));
...
?>
<div class="header">
    <h2><?= Lang::get('tools', 'label_aliases') ?><?= ($LabelName ? " for <a href=\"labels.php?id=$LabelID\">$LabelName</a>" : '') ?></h2>
    <div class="linkbox">
        <a href="tools.php?action=label_aliases&amp;order=GoodLabels" class="brackets"><?= Lang::get('tools', 'sort_by_good_labels') ?></a>
        <a href="tools.php?action=label_aliases&amp;order=BadLabels" class="brackets"><?= Lang::get('tools', 'sort_by_bad_labels') ?></a>
    </div>
</div>
<table width="100%">
    <tr class="colhead">
        <td><?= Lang::get('tools', 'sort_by_bad_labels') ?></td>
