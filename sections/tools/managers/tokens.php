...
?>
<div class="header">
    <h2><?= Lang::get('tools', 'add_fl_tokens_to_all_enabled_users') ?></h2>
    <div class="linkbox">
...
<div class="box pad" style="margin-left: auto; margin-right: auto; text-align: center; max-width: 40%;">
    ...
    <form class="add_form" name="fltokens" action="" method="post">
        ...
        <?= Lang::get('tools', 'tokens_to_add') ?>: <input type="text" name="numtokens" size="5" style="text-align: right;" value="0" /><br /><br />
...
<div class="box pad" style="margin-left: auto; margin-right: auto; text-align: center; max-width: 40%;">
    ...
    <form class="manage_form" name="fltokens" action="" method="post">
        <input type="hidden" name="action" value="tokens" />
        <input type="hidden" name="auth" value="<?= $LoggedUser['AuthKey'] ?>" />
        <?= Lang::get('tools', 'tokens_to_set') ?>: <input type="text" name="numtokens" size="5" style="text-align: right;" value="0" /><br /><br />
        <span id="droptokens" class=""><label for="onlydrop"><?= Lang::get('tools', 'only_affect_users_with_at_least_this_many_tokens') ?>: </label><input type="checkbox" id="onlydrop" name="onlydrop" value="1" onchange="$('#disabled').gtoggle(); return true;" /></span><br />
        <span id="disabled" class=""><label for="leechdisabled"><?= Lang::get('tools', 'also_add_tokens_to_leech_disabled_users') ?>: </label><input type="checkbox" id="leechdisabled" name="leechdisabled" value="1" onchange="$('#droptokens').gtoggle(); return true;" /></span><br /><br />
