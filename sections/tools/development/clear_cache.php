...
View::show_header(Lang::get('tools', 'clear_a_cache_key'));
...
?>
<div class="header">
    <h2><?= Lang::get('tools', 'clear_a_cache_key') ?></h2>
</div>
    ...
    <tr>
        ...
        <td>
            <form class="manage_form" name="cache" method="get" action="">
                ...
                <select name="type">
                    <option value="view"><?= Lang::get('tools', 'view') ?></option>
                    <option value="clear"><?= Lang::get('tools', 'clear') ?></option>
                </select>
