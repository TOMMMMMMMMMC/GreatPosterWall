...
View::show_header(Lang::get('tools', 'service_stats'));
?>
<div class="linkbox">
...
<div class="permissions">
    <div class="permission_container">
        <table>
            <tr class="colhead">
                <td colspan="2"><?= Lang::get('tools', 'service') ?></td>
            </tr>
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'threads_active') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
                <td><?= number_format($MemStats['threads']) ?> <span style="float: right;">(100.000%)</span></td>
            </tr>
            <tr>
                <td<? if ($DBStats['Threads_connected']['Value'] / $DBStats['Threads_created']['Value'] > 0.7) {
                        echo ' class="invalid" ';
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'connections') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'special') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cashe_current_index') ?>:</td>
                <td><?= number_format($MemStats['curr_items']) ?></span></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cashe_total_index') ?>:</td>
                <td><?= number_format($MemStats['total_items']) ?></span></td>
            </tr>
            <tr>
                <td<? if ($MemStats['bytes'] / $MemStats['limit_maxbytes'] > 0.85) {
                        echo ' class="tooltip invalid" title="' . Lang::get('tools', 'cashe_storage_title') . '" ';
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'utilities') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'global_cache') ?>:</td>
                <td>
                    <form class="delete_form" name="cache" action="" method="post">
                        ...
                        <input type="submit" value="全局刷新" />
                    </form>
                </td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'publish_a_new_announcement') ?></td>
                <td>
                    <form class="delete_form" name="cache" action="" method="post">
                        <input type="hidden" name="action" value="service_stats" />
                        <input type="hidden" name="auth" value="<?= $LoggedUser['AuthKey'] ?>" />
            ...
            <tr>
                <td><?= Lang::get('tools', 'edit_an_announcement') ?></td>
                <td>
                    <form class="delete_form" name="cache" action="" method="post">
                        <input type="hidden" name="action" value="service_stats" />
                        <input type="hidden" name="auth" value="<?= $LoggedUser['AuthKey'] ?>" />
    ...
    <div class="permission_container">
        <table>
            <tr class="colhead">
                <td colspan="2"><?= Lang::get('tools', 'activity') ?></td>
            </tr>
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'total_reads') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'total_writes') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'get_select_success') ?></strong></td>
            </tr>
            <tr>
                <td<? if ($MemStats['get_hits'] / $MemStats['cmd_get'] < 0.7) {
                        echo ' class="invalid" ';
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'set_insert_success') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'increment_decrement_success') ?></strong></td>
            </tr>
            <tr>
                <td<? if ($MemStats['incr_hits'] / ($MemStats['incr_hits'] + $MemStats['incr_misses']) < 0.7) {
                        echo ' class="invalid" ';
            ...
            <tr>
                <td<? if ($MemStats['decr_hits'] / ($MemStats['decr_hits'] + $MemStats['decr_misses']) < 0.7) {
                        echo ' class="invalid" ';
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'cas_update_success') ?></strong></td>
            </tr>
            <tr>
                <td<? if ($MemStats['cas_hits'] > 0 && $MemStats['cas_hits'] / ($MemStats['cas_hits'] + $MemStats['cas_misses']) < 0.7) {
                        echo ' class="tooltip invalid" title="' . Lang::get('tools', 'cas_update_success_title_1') . '" ';
                    } elseif ($MemStats['cas_hits'] == 0) {
                        echo ' class="tooltip notice" title="' . Lang::get('tools', 'cas_update_success_title_2') . '" ';
                    } ?>><?= Lang::get('tools', 'cache') ?>:</td>
                    <td><?= number_format($MemStats['cas_hits']) ?> <span style="float: right;">(<? if ($MemStats['cas_hits'] > 0) {
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'delete_success') ?></strong></td>
            </tr>
            <tr>
                <td<? if ($MemStats['delete_hits'] / ($MemStats['delete_hits'] + $MemStats['delete_misses']) < 0.7) {
                        echo ' class="tooltip invalid" title="' . Lang::get('tools', 'delete_success_title') . '"';
                    } ?>><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td<? if ($MemStats['cmd_flush'] > $MemStats['uptime'] / 7 * 24 * 3600) {
                        echo ' class="tooltip invalid" title="' . Lang::get('tools', 'cache_flushes_title') . '" ';
                    } ?>><?= Lang::get('tools', 'cache_flushes') ?>:</td>
                    <td><?= number_format($MemStats['cmd_flush']) ?></td>
            </tr>
            <tr>
                <td<? if ($MemStats['evictions'] > 0) {
                        echo ' class="invalid" ';
                    } ?>><?= Lang::get('tools', 'cache_evicted') ?>:</td>
                    <td><?= number_format($MemStats['evictions']) ?></td>
            </tr>
            <tr>
                <td<? if ($DBStats['Slow_queries']['Value'] > $DBStats['Questions']['Value'] / 7500) {
                        echo ' class="tooltip invalid" title="' . Lang::get('tools', 'database_slow_title') . '" ';
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'data_read') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'data_write') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
    ...
    <div class="permission_container">
        <table>
            <tr class="colhead">
                <td colspan="2"><?= Lang::get('tools', 'concurrency') ?></td>
            </tr>
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'total_reads') ?></strong></td>
            </tr>
            <tr>
                <td<? if (($MemStats['cmd_get'] / $MemStats['uptime']) * 5 < $DBStats['Com_select']['Value'] / $DBStats['Uptime']['Value']) {
                        echo ' class="invalid" ';
                    } ?>><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td<? if (($MemStats['cmd_set'] / $MemStats['uptime']) * 5 < ($DBStats['Com_insert']['Value'] + $DBStats['Com_update']['Value']) / $DBStats['Uptime']['Value']) {
                        echo ' class="invalid" ';
                    } ?>><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'get_select') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'set_insert') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
                <td><?= number_format($MemStats['cmd_set'] / $MemStats['uptime'], 5) ?>/s</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'increment_decrement') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache_increment') ?>:</td>
                <td><?= number_format($MemStats['incr_hits'] / $MemStats['uptime'], 5) ?>/s</td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache_decrement') ?>:</td>
                <td><?= number_format($MemStats['decr_hits'] / $MemStats['uptime'], 5) ?>/s</td>
            </tr>
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'cas_updates') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
            ...
            <tr>
                <td colspan="2"><strong><?= Lang::get('tools', 'deletes') ?></strong></td>
            </tr>
            <tr>
                <td><?= Lang::get('tools', 'cache') ?>:</td>
