...
<div class="box pad" id="unused_invites">
...
<div>
    <form class="search_form" name="invites" action="" method="get">
        <table cellpadding="6" cellspacing="1" border="0" class="layout border" width="100%">
            <tr>
                <td class="label"><strong><?= Lang::get('tools', 'email_address') ?>:</strong></td>
                <td>
...
<table width="100%">
    <tr class="colhead">
        <td><?= Lang::get('tools', 'inviter') ?></td>
        <td><?= Lang::get('tools', 'email_address') ?></td>
        <td><?= Lang::get('tools', 'ip_address') ?></td>
        <td><?= Lang::get('tools', 'invite_code') ?></td>
        <td><?= Lang::get('tools', 'expires') ?></td>
        <? if (check_perms('users_edit_invites')) { ?>
            <td><?= Lang::get('tools', 'controls') ?></td>
        <? } ?>
    </tr>
    <?
    $Row = 'b';
