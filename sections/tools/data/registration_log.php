...
View::show_header(Lang::get('tools', 'registration_log'));
...
<form action="" method="post" acclass="thin box pad">
    ...
    <?= Lang::get('tools', 'joined_after') ?>: <input type="date" name="after_date" />
    <?= Lang::get('tools', 'joined_before') ?>: <input type="date" name="before_date" />
    <input type="submit" />
</form>
...
?>
    ...
    <table width="100%">
        <tr class="colhead">
            ...
            <td><?= Lang::get('tools', 'ratio') ?></td>
            <td><?= Lang::get('tools', 'email') ?></td>
            <td><?= Lang::get('tools', 'ip_address') ?></td>
            <td><?= Lang::get('tools', 'country') ?></td>
            <td><?= Lang::get('tools', 'host') ?></td>
        ...
        ?>
            <tr class="row<?= $Row ?>">
                ...
                <td>
                    ...
                    <span style="float: right;"><a href="userhistory.php?action=email&amp;userid=<?= $UserID ?>" title="<?= Lang::get('tools', 'history') ?>" class="brackets tooltip">H</a> <a href="/user.php?action=search&amp;email_history=on&amp;email=<?= display_str($Email) ?>" title="<?= Lang::get('tools', 'search') ?>" class="brackets tooltip">S</a></span><br />
                    <span style="float: left;"><?= display_str($InviterEmail) ?></span>
                    <span style="float: right;"><a href="userhistory.php?action=email&amp;userid=<?= $InviterID ?>" title="<?= Lang::get('tools', 'history') ?>" class="brackets tooltip">H</a> <a href="/user.php?action=search&amp;email_history=on&amp;email=<?= display_str($InviterEmail) ?>" title="<?= Lang::get('tools', 'search') ?>" class="brackets tooltip">S</a></span><br />
                </td>
                <td>
                    <span style="float: left;"><?= display_str($IP) ?></span>
                    <span style="float: right;"><?= display_str($Uses) ?> <a href="userhistory.php?action=ips&amp;userid=<?= $UserID ?>" title="<?= Lang::get('tools', 'history') ?>" class="brackets tooltip">H</a> <a href="/user.php?action=search&amp;ip_history=on&amp;ip=<?= display_str($IP) ?>" title="<?= Lang::get('tools', 'search') ?>" class="brackets tooltip">S</a> <a href="http://whatismyipaddress.com/ip/<?= display_str($IP) ?>" title="<?= Lang::get('tools', 'wi') ?>" class="brackets tooltip">WI</a></span><br />
                    <span style="float: left;"><?= display_str($InviterIP) ?></span>
                    <span style="float: right;"><?= display_str($InviterUses) ?> <a href="userhistory.php?action=ips&amp;userid=<?= $InviterID ?>" title="<?= Lang::get('tools', 'history') ?>" class="brackets tooltip">H</a> <a href="/user.php?action=search&amp;ip_history=on&amp;ip=<?= display_str($InviterIP) ?>" title="<?= Lang::get('tools', 'search') ?>" class="brackets tooltip">S</a> <a href="http://whatismyipaddress.com/ip/<?= display_str($InviterIP) ?>" title="<?= Lang::get('tools', 'wi') ?>" class="brackets tooltip">WI</a></span><br />
                </td>
                <td>
                    <?= $IPCC ?> <br />
                    <?= $InviterIPCC ?>
