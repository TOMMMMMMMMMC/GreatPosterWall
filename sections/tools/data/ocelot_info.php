...
View::show_header(Lang::get('tools', 'tracker_info'));
?>
<div class="thin">
    <div class="header">
        <h2><?= Lang::get('tools', 'tracker_info') ?></h2>
    </div>
    <div class="linkbox">
    ...
    <div class="grid_container">
        <div class="sidebar">
            <div class="box box2">
                <div class="head"><strong><?= Lang::get('tools', 'user_stats') ?></strong></div>
                <div class="pad">
                    <form method="get" action="">
                        <input type="hidden" name="action" value="ocelot_info" />
                        <span class="label"><?= Lang::get('tools', 'get_stats_for_user') ?></span><br />
                        <input type="text" name="userid" placeholder="<?= Lang::get('tools', 'user_id') ?>" value="<? Format::form('userid') ?>" />
