...
<div class="thin">
    ...
    if (isset($_GET['tag']) || isset($_GET['replace'])) {
        ...
        if ($Err) {
            ...
            echo "\n" . '<div class="box pad center"><strong>' . Lang::get('tools', 'success_exclamation_mark') . '</strong>' . Lang::get('tools', 'affected_entries') . ': ' . number_format($TotalAffected) . '</div>';
    ...
    ?>
                ...
                <table>
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'affected_torrent_groups') ?></td>
                    </tr>
                    <?
                    ...
                    ?>
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'affected_requests') ?></td>
                    </tr>
                    <?
