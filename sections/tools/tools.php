...
View::show_header(Lang::get('tools', 'staff_tools'));
?>
    ...
    <div class="permission_container">
        ...
        ?>
            <div class="permission_subcontainer">
                <table class="layout">
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'administration') ?></td>
                    </tr>
                    <?= $ToolsHTML ?>
                </table>
            </div>
        ...
        create_row(Lang::get('tools', 'vanity_house_additions'), "tools.php?action=recommend", check_perms("site_recommend_own") || check_perms("site_manage_recommendations"));
        create_row(Lang::get('tools', 'album_of_the_month'), "tools.php?action=monthalbum", check_perms("users_mod"));
        create_row(Lang::get('tools', 'vanity_house'), "tools.php?action=vanityhouse", check_perms("users_mod"));
        ...
        ?>
            <div class="permission_subcontainer">
                <table class="layout">
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'announcements') ?></td>
                    </tr>
                    <?= $ToolsHTML ?>
                </table>
            </div>
        ...
        ?>
            <div class="permission_subcontainer">
                <table class="layout">
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'community') ?></td>
                    </tr>
                    <?= $ToolsHTML ?>
                </table>
            </div>
    ...
    <div class="permission_container">
        ...
        ?>
            <div class="permission_subcontainer">
                <table class="layout">
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'developer_sandboxes') ?></td>
                    </tr>
                    <?= $ToolsHTML ?>
                </table>
            </div>
    ...
    <div class="permission_container">
        ...
        ?>
            <div class="permission_subcontainer">
                <table class="layout">
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'site_information') ?></td>
                    </tr>
                    <?= $ToolsHTML ?>
                </table>
            </div>
        ...
        create_row(Lang::get('tools', 'label_aliases'), "tools.php?action=label_aliases", check_perms("users_mod"));
        ...
        create_row(Lang::get('tools', 'update_drive_offsets'), "tools.php?action=update_offsets", check_perms("users_mod"));
        ...
        ?>
            <div class="permission_subcontainer">
                <table class="layout">
                    <tr class="colhead">
                        <td><?= Lang::get('tools', 'development') ?></td>
                    </tr>
                    <?= $ToolsHTML ?>
                </table>
            </div>
