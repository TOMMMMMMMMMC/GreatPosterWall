...
<div class="thin">
    <div class="header">
        <h2><?= Users::format_username($UserID, false, false, false) ?> &gt; <?= Lang::get('badges', 'index_badge') ?> &gt; <?= Lang::get('badges', 'badge_achievement_progress') ?></h2>
    </div>
    <div class="linkbox">
            ...
            <div class="body" id="data_group">
                ...
                ?>
                    <div id="badge_<?= $Label ?>" class="<?= $BadgeLabel['Father'] ? "father" : "son" ?> badge_and_progress">
                        <div class="badge_img_container" title="<?= Badges::get_text($Label, 'badge_title') ?>">
                        ...
                        <div class="title_and_progressbar">
                            ...
                            <div class="progressbar" title="<?= number_format($BadgesCount[$Label], 2) ?>">
                                <?
                                $BadgeP = 0;
                                $LastBadgeCount = 0;
                                foreach ($Badges as $Badge) {
                                ...
                                ?>
                                    ...
                                    <div class="level<?= $Badge['Level'] ?> circle_container<?= $Has ? ($NowBadge['Level'] == $Badge['Level'] ? " current" : " achieved") : "" ?>">
                                        <div class="level<?= $Badge['Level'] ?> circle">
                                            <i class="fa fa-check tooltip<?= $Has && $NowBadge['Level'] == $Badge['Level'] ? "" : " hidden" ?>"></i>
                                        </div>
                                    </div>
                                <?
                                }
