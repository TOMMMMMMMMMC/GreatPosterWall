...
<div class="thin">
    ...
    <div class="header">
        <h2><?= Users::format_username($UserID, false, false, false) ?> &gt; <?= Lang::get('badges', 'index_badge') ?> &gt; <?= Lang::get('badges', 'badge_display') ?></h2>
    </div>
    <div class="linkbox">
                    ...
                    <div class="card" id="uploaded">
                        <div class="card_inside">
                            <div class="badge_container">
                                <img onclick="showBadges('<?= $Label ?>')" src="<?= $NowBadge ? $NowBadge['BigImage'] : $BadgeLabel['DisImage'] ?>" title="<?= Badges::get_text($Label, 'badge_title') ?>">
                            </div>
                            ...
                            <div class="badge_display_btns">
                                <a id="wear_badge_<?= $Label ?>" <?= $Wear ? " class=\"active\"" : "" ?> title="<?= Badges::get_text('button', 'wear_badge') ?>" <?= $NowBadge ? " href=\"javascript:" . ($Wear ? "unW" : "w") . "earBadge('$Label')\"" : "" ?>>
                                    <i class="fas fa-award"></i>
                                </a>
                                <a id="display_badge_<?= $Label ?>" <?= $Display ? " class=\"active\"" : "" ?> title="<?= Badges::get_text('button', 'display_badge') ?>" <?= $NowBadge ? " href=\"javascript:" . ($Display ? "unD" : "d") . "isplayBadge('$Label')\"" : "" ?>>
