...
class BindCommand extends Command {
     ...
     * @var string Command Description
     */
    protected $description = "通过你的 GPW 用户名和种子密钥末 8 位与 TG 账号绑定 | Bind your account with your USERNAME & TORRENT PASSKEY (last 8 characters)";
    ...
    public function handle($arguments) {
        ...
        if ($HasUser) {
            ...
            if ($CloseLogin) {
                ...
                $this->replyWithMessage(['text' => "https://greatposterwall.com/login.php?loginkey=$Key"]);
            } else {
