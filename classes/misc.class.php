...
class Misc {
        ...
        switch (EMAIL_DELIVERY_TYPE) {
            case 'local':
                ...
                try {
                    ...
                    $mail->Username = 'noreply@greatposterwall.com';     // SMTP username
                    $mail->Password = '2991d7f9dccca01e873ad8bcf6e894b4-602cc1bf-c550c1a6';       // SMTP password
                    $mail->SMTPSecure = 'ssl';       // Enable TLS encryption, `ssl` also accepted
                    $mail->Port = 465;         // TCP port to connect to
                    $mail->setFrom('noreply@greatposterwall.com', 'Great Poster Wall');
    ...
    public static function send_pm_with_tpl($ToID, $Template, $Params = [], $FromID = 0, $ConvID = '') {
        global $Twig;
        $CHSTPL = $Twig->load('privatemessage/chs/' . $Template . '.twig');
        $ENTPL = $Twig->load('privatemessage/en/' . $Template . '.twig');
