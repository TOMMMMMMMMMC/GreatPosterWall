            ...
            if (self::$Levels < self::$MaximumNests) {
                switch ($Block['Type']) {
                    ...
                    case 'bdinfo':
                        ...
                        $Str .= $Title;
                        $Str .= "</a><div class=\"bdinfo-bbcode hidden\"><pre>" . $Block['Val'] . "</pre></div><div class=\"bdinfo-bbcode\">";
                        ...
                        $Str .= "<table class=\"bdinfo-table\"><tr><td>" . $BDInfo['General'] . "</td><td>" . $BDInfo['Video'] . "</td><td>" . $BDInfo['Audio'] /*. $MediaInfo['Text']*/ . "</td></tr></table>";
                        $Str .= "</div>";
                    ...
                    case 'mediainfo':
                        ...
                        $Str .= "</a><div class=\"mediainfo-bbcode hidden\"><pre>" . $Block['Val'] . "</pre></div><div class=\"mediainfo-bbcode\">";
                        ...
                        $Str .= "<table class=\"mediainfo-table\"><tr><td>" . $MediaInfo['General'] . "</td><td>" . $MediaInfo['Video'] . "</td><td>" . $MediaInfo['Audio'] /*. $MediaInfo['Text']*/ . "</td></tr></table>";
                        $Str .= "</div>";
                        break;
                    case 'comparison':
                        $Block['Val'] = str_replace("\r\n", "\n", $Block['Val']);
