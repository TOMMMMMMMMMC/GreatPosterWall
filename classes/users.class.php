        ...
        if ($IsWarned && $IsEnabled) {
            if ($UserInfo['Warned'] != '0000-00-00 00:00:00') {
                $Str .= '<a href="wiki.php?action=article&amp;id=114"'
                    . '><i class="fa fa-exclamation-triangle tooltip warned-flag" aria-hidden="true" title="Warned'
                ...
                if ($DisabledTitle) {
                    ...
                    $Str .= '<i class="fa fa-exclamation-triangle tooltip half-warned-flag" aria-hidden="true" title="' . $DisabledTitle . '" class="tooltip" ></i>';
                }
            }
        }
        $Str .= ($IsEnabled && $UserInfo['Enabled'] == 2) ? '<a href="rules.php"><i class="fa fa-ban tooltip disabled_flag" aria-hidden="true"></i></a>' : '';
