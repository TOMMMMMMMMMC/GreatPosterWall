...
class TorrentsDL {
     ...
     */
    public static function construct_file_name($Artist, $Album, $Source, $Codec, $Container, $Resolution, $Makers, $Year, $TorrentID = false, $Txt = false, $MaxLength = self::MaxPathLength) {
        $MaxLength -= ($Txt ? 4 : 8);
        if ($TorrentID !== false) {
