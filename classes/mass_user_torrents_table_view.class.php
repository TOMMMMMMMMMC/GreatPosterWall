...
?>
        <div class="thin">
            <div class="header">
                <h2><?= Lang::get('bookmarks', 'no_torrents_found') ?></h2>
            </div>
        ...
        ?>
            ...
            <div class="thin">
                ...
                <table width="100%" class="layout">
                    <tr class="colhead">
                        <td id="sorting_head"><?= Lang::get('bookmarks', 'sorting') ?></td>
                    </tr>
                    <tr>
                ...
                <form action="bookmarks.php" method="post" id="drag_drop_collage_form">
                    ...
                    <table id="manage_collage_table">
                        <thead>
                            <tr class="colhead">
                                <th style="width: 7%;" data-sorter="false"><?= Lang::get('bookmarks', 'order') ?></th>
                                <th style="width: 1%;"><span><abbr class="tooltip" title="<?= Lang::get('bookmarks', 'current_order') ?>">#</abbr></span></th>
                                <th style="width: 1%;"><span><?= Lang::get('bookmarks', 'year') ?></span></th>
                                ...
                                <th style="width: 5%;" data-sorter="relativeTime"><span><?= Lang::get('bookmarks', 'bookmarked') ?></span></th>
                                <th style="width: 1%;" id="check_all" data-sorter="false"><span><?= Lang::get('bookmarks', 'remove') ?></span></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
    ...
    <?php
                ...
                public static function display_name(array &$ExtendedArtists, array &$Artists, $VanityHouse) {
                    $DisplayName = '';
                    if (
                        !empty($ExtendedArtists[1]) || !empty($ExtendedArtists[4])
