...
require(__DIR__ . '/../classes/misc.class.php'); // Require the misc class
require(__DIR__ . '/../classes/cache.class.php'); // Require the caching class
require(__DIR__ . '/../classes/feed.class.php'); // Require the feeds class
