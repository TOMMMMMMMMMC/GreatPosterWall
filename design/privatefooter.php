...
<?
$Scripts = array_merge(array('tooltipster.bundle.min', 'tooltipster-discovery.min', 'global'), explode(',', $FooterJSIncludes));
foreach ($Scripts as $Script) {
    if (trim($Script) == '') {
        continue;
    }
?>
    <script src="/js/<?= $Script ?>.js?v=<?= filemtime(SERVER_ROOT . static_prefix() . '/js/' . $Script . '.js') ?>" type="text/javascript"></script>
<?
}
?>
