...
<head>
    ...
    $style = '';
    ?>
    <link href="<?= STATIC_SERVER ?>styles/public/style<?= $style ?>.css?v=<?= filemtime(SERVER_ROOT . "/public/static/styles/public/style{$style}.css") ?>" rel="stylesheet" type="text/css" />
