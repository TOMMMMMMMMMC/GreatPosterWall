...
$lang_register = array(
    ...
    'register_invalid' => "The DIC account of this email does not conform to the requirement",
    'register_closed_note' => "<strong>Sorry, the site is currently invite only. </strong>",
    'new_installation' => "Since this is a new installation, you can log in directly without having to confirm your account.",
