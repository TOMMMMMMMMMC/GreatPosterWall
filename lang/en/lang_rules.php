...
$lang_rules = array(
    ...
    'golden_rules_used' => "The Golden Rules encompass all of GreatPosterWall and the GPW IRC network. These rules are paramount; non-compliance will jeopardize your account.",
    ...
    'long_13' => "Accounts are for personal use only. Granting access to your account in any way (e.g., shared login details, external programs) is prohibited. <a href=\"wiki.php?action=article&name=invite\">Invite</a> friends or direct them to our <a href=\"https://t.me/joinchat/If6Vp8_nO7lmY2Jl\" target='_blank'>official Telegram group</a>.",
    ...
    'long_24' => "Do not mention \"GreatPosterWall\" or \"GPW\" in any public area, you may use \"Seal\" or \"Haibao\" to replace. And do not reveal our site url or tracker url. Please hide our Logo when you capturing a screenshot.",
    ...
    'long_51' => "You may browse the site through a VPN/proxy only if you have paid for this service. This includes (for example) self-hosted VPNs or proxies, services like NordVPN and VPNs or proxies that come with a seedbox. The use of Tor for browsing the site or seeding is not allowed. You may seed from up to 3 IPs at the same time. When in doubt, please send a ${staffpm}. <i style=\"color: #ed5454\">Update! 2021-06-23</i>",
    ...
    'upload_h63k' => "Seeding as long as you can. GPW plan to be a library for all movies and all formats permanently. Longer seeding, better tracker. As a member of GPW, you need to be strict with yourself.",
    ...
    'upload_h11k_note' => "<li id='r1.1.1'><a href='#h1.1'><strong></strong></a> <a href='#r1.1.1'>1.1.1.</a>
   ...
   <li id='r2.1.3'><a href='#h2.1'><strong></strong></a> <a href='#r2.1.3'>2.1.3.</a> <strong>Keep your torrent clean. </strong>Don't include: samples, screenshots, desktop.ini/thumbs.db files, or anything that not relevant to your upload. Ripping logs etc. are allowed in DVD/BD structures. Please <a href='https://greatposterwall.com/subtitles.php'>upload subtitle files separately</a> and don't include them in the torrents.
   </li>
   <li id='r2.1.4'><a href='#h2.1'><strong></strong></a> <a href='#r2.1.4'>2.1.4.</a> <strong>DVD/BD structures should not be modified, only the top-level folder can be renamed.</strong>
    ...
    'upload_h22k_note' => "<ul>
   <li id='r2.2.1'><a href='#h2.2'><strong></strong></a> <a href='#r2.2.1'>2.2.1.</a> <strong>Screenshots: You should provide at least 3 display resolution PNG screenshots in \"Torrent Description\" area at upload page. They have to be saved at <a href='https://greatposterwall.com/upload.php?action=image'>official image host</a>. You can also use </strong> <a href='https://pixhost.to'>https://pixhost.to</a>, <a href='https://ptpimg.me'>https://ptpimg.me</a>, <a href='https://malzo.com'>https://malzo.com</a>, <a href='https://imgbox.com'>https://imgbox.com</a> or <a href='https://img.pterclub.com'>https://img.pterclub.com</a> as an alternative. You need to provide at least 1 screenshot per episode for series-kind torrents.
   </li>
...
<ul>
   ...
   <li id='r3.3.3'><a href='#h3.3'><strong></strong></a> <a href='#r3.3.3'>3.3.3.</a> <strong>UHD encodes must use x265 codec and MKV container. Web source UHD torrents with x264 codec are allowed.</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
   <ul>
...
<ul>
   ...
   <li id='r3.6.2'><a href='#h3.6'><strong></strong></a> <a href='#r3.6.2'>3.6.2.</a> <strong>Subtitle formats allowed by GPW are .sub, .idx, .sup, .srt, .vtt, .ass, .smi, and .ssa. </strong>They can also be compressed to .rar, .zip, .7z, .tar, .tgz, or .tar.gz.
   </li>
   ...
   <li id='r3.6.5'><a href='#h3.6'><strong></strong></a> <a href='#r3.6.5'>3.6.5.</a> <strong>Please upload a single subtitle file for one-file movie. DO NOT compress different languages subtitle files together. </strong>For example, including Simplified Chinese SRT, Traditional Chinese SRT and Chinese & English SRT in a single archive file is not allowed. They should be uploaded separately. <strong>For miniseries, compressing subtitles for episodes together is allowed. </strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
    ...
    'upload_h40k_note' => "<ul>
<li id='r4.0.1'><a href='#h4.0'><strong></strong></a> <a href='#r4.0.1'>4.0.1.</a> <strong>Here is a diagram for our slots (special editions are not considered) below. A slot means an empty \"seat\" for a new upload, once was all occupied, the latest upload must trump older torrents or be removed.</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
<table border='1' id='slot_table'>
<tr>
   <th style='width: 45px'>Content</th>
   <th style='width: 85px'>Slot type</th>
   <th style='width: 160px'>Subtitle requirement</th>
   <th>Codec</th>
   <th style='width: 180px'>Divide by resolution</th>
   <th>Description</th>
</tr>

<tr>
   <td rowspan='11'>Main movie</td>
   <td rowspan='2'>Encode<br/>CN Quality Slot</td>
   <td rowspan='2'>Must softcode a Chinese subtitle<br/>(hardcoded or external subtitles are not counted)</td>
   <td>x264</td>
   <td>SD / 720p / 1080p (3 slots)</td>
   <td rowspan='4'>Trump priority: high quality > small size</td>
</tr>
<tr>
   <td>x265</td>
   <td>HDR 1080p / 2160p (2 slots)</td>
</tr>
<tr>
   <td rowspan='2'>Encode<br/>EN Quality Slot</td>
   <td rowspan='2'>Recommended to softcode an English subtitle<br/>(hardcoded subtitles are not counted)</td>
   <td>x264</td>
   <td>SD / 720p / 1080p (3 slots)</td>
</tr>
<tr>
...
<tr>
   <td rowspan='2'>Encode<br/>Rentention Slot</td>
   <td rowspan='2'>No requirement</td>
   <td>x264</td>
   <td>720p / 1080p (2 slots)</td>
   <td rowspan='2'>Trump priority: Higher quality is better when the sizes are the same, smaller size is better when the qualities are the same</td>
</tr>
<tr>
   <td>x265</td>
   <td>2160p (1 slot)</td>
...
<tr>
   <td rowspan='2'>Encode<br/>Feature Slot</td>
   <td rowspan='2'>Must softcode a Chinese subtitle or have a Mandarin dub<br/>(hardcoded or external subtitles are not counted)</td>
   <td>x264</td>
   <td>720p / 1080p (2 slots)</td>
   <td rowspan='2'>Trump priority: more Mandarin dubs / special effects subtitles > better Mandarin dubs / special effects subtitles > high quality encode<br/>Only for Non-Chinese movies, only have Mandarin dubs or special effects subtitles is not enough</td>
</tr>
<tr>
   <td>x265</td>
   <td>2160p (1 slot)</td>
...
<tr>
   ...
   <td>-</td>
   <td>720p / 1080p / 2160p (3 slots)</td>
   <td>Trump priority: high quality discs > internal Chinese subtitle</td>
</tr>
<tr>
   <td>Untouched Slot</td>
   <td>No requirement</td>
   <td>-</td>
   <td>SD x2 / 720p / 1080p / 2160p<br/>(5 slots)</td>
   <td>Trump priority: high quality discs<br/>You may upload ISO images or M2TS containers (BluRay Only)</td>
</tr>
<tr>
   <td>DIY Slot</td>
   <td>No requirement</td>
   <td>-</td>
   <td>1080p / 2160p (2 slots)</td>
   <td>Trump priority: more Mandarin dubs / special effects subtitles > better Mandarin dubs / special effects subtitles > high quality encode<br/>Only for Non-Chinese movies, only have Mandarin dubs or special effects subtitles is not enough. You may upload ISO images or M2TS containers</td>
</tr>
<tr>
   <td rowspan='2'>Extra</td>
   <td rowspan='2'>Encode<br/>Quality Slot</td>
   <td rowspan='2'>No requirement</td>
   <td>x264</td>
   <td>SD / 720p / 1080p (3 slots)</td>
   <td rowspan='2'>Trump priority: high quality > small size</td>
</tr>
<tr>
   <td>x265</td>
   <td>2160p (1 slot)</td>
...
<ul>
   ...
   <li id='r4.5.2'><a href='#h4.5'><strong></strong></a> <a href='#r4.5.2'>4.5.2.</a> <strong>Extras packs from different editions can coexist if their content is actually different. </strong>If they are the same, the slot will be provided to the most complete pack.
    ...
    'upload_h46k_note' => "
<ul>
   <li id='r4.6.1'><a href='#h4.6'><strong></strong></a> <a href='#r4.6.1'>4.6.1.</a> <strong>Each cut of a movie (e.g. Theatrical/Director's, Rated/Unrated, etc.) is allowed its own set of Slots. Give each type of HDR format torrents a set of standalone slots.</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
   </li>
...
<ul>
   <li id='r5.2.1'><a href='#h5.2'><strong></strong></a> <a href='#r5.2.1'>5.2.1.</a> <strong>Any torrent that not met requirements of <a href='#h3'>the relevant rules section</a> can be trumped by preferred format torrents with a equivalent or superior quality.</strong>
       <ul>
		   ...
		   <li id='r5.2.1.1'><a href='#r5.2.1'><strong></strong></a> <strong>Dolby Vision remuxes and Chinese streaming site WEB-DL can use the MP4 container. </strong>Changing the container to MKV can not trump them.<i style=\"color: #ed5454\">New! 2021-08-14</i>
           </li>
       </ul>
   </li>
...
<ul>
   ...
   <li id='r5.4.3'><a href='#h5.4'><strong></strong></a> <a href='#r5.4.3'>5.4.3.</a> <strong>Bloated：</strong>The video or audio bitrate of this upload is too high. A handy sheet for maximum audio bitrates: <i style=\"color: #ed5454\">Update! 2021-08-06</i>
   <table border='1'>
   <tr>
       <td colspan='2' rowspan='2'>Source Audio</td>
   ...
   <li id='r5.4.16'><a href='#h5.4'><strong></strong></a> <a href='#r5.4.16'>5.4.16.</a> <strong>Non-original audio track: </strong>when a film has no original audio track, Mandarin dub and English dub at the same time (only other small language dubs included), this mark would be applied.<i style=\"color: #ed5454\">Update! 2021-08-14</i>
   </li>
   ...
   <li id='r5.4.24'><a href='#h5.4'><strong></strong></a> <a href='#r5.4.24'>5.4.24.</a> <strong>Dead: </strong>This upload has not been seeded for at least 4 weeks. This mark is appended and removed automatically.
    ...
    'chat_forums_irc' => "<li>Do not belittle or slander any other tracker on any occasion under the jurisdiction of GPW.</li>
    ...
    'tags_summary' => "<li>Tags should be comma-separated, and you should use a period (\".\") to separate words inside
        a tag. Such as \"<strong class='important_text_alt'>sci.fi</strong>\" or \"<strong
            class='important_text_alt'>post.rock</strong>\".</li>
    <li>You can select from the dropdown box on <a href=\"upload.php\" target=\"_blank\">the torrent upload page</a>. We
        ...
        feel qualified to be more specific. <strong>Please note that the \"<strong
                class='important_text_alt'>2000s</strong>\" tag refers to music produced between 2000 and 2009.</strong>
    </li>
    <li>Do not add 'useless' tags, such as personal opinions or anything you specify elsewhere on the form. \"<strong
            class='important_text'>seen.live</strong>\", \"<strong class='important_text'>awesome</strong>\", \"<strong
            class='important_text'>kung.fu</strong>\" (containing in \"<strong
            class='important_text_alt'>action</strong>\") etc.. If an upload contains live contents, you can tag it as \"<strong
            class='important_text_alt'>live</strong>\".</li>
    <li>Only tag information on the movie itself&#8202;&mdash;&#8202;<strong>not the individual release</strong>. Tags
        such as \"<strong class='important_text'>remux</strong>\", \"<strong class='important_text'>encode</strong>\",
        \"<strong class='important_text'>blu.ray</strong>\", \"<strong class='important_text'>eac3to</strong>\", etc.
    ...
    'tags_summary_onupload' => "<li>Tags should be comma-separated, and you should use a period (\".\") to separate
        words inside a tag. Such as \"<strong class='important_text_alt'>hip.hop</strong>\" or \"<strong
            class='important_text_alt'>post.rock</strong>\".</li>
    <li>There is a list of official tags you can select from the dropdown box above. We recommend adding more specific
        ...
        specific. <strong>Please note that the \"<strong class='important_text_alt'>2000s</strong>\" tag refers to music
    ...
    <li>Avoid abbreviations if at all possible. So instead of tagging an album as \"<strong
            class='important_text'>alt.rock</strong>\" or \"<strong class='important_text'>prog</strong>\", tag it as
        \"<strong class='important_text_alt'>alternative.rock</strong>\" or \"<strong
            class='important_text_alt'>progressive.rock</strong>\". Make sure that you use correct spelling.</li>
    <li>Do not add 'useless' tags, such as personal opinions or anything you specify elsewhere on the form. \"<strong
            class='important_text'>seen.live</strong>\", \"<strong class='important_text'>awesome</strong>\", \"<strong
            class='important_text'>flac</strong>\", etc. If an album contains live contents, you can tag it as \"<strong
            class='important_text_alt'>live</strong>\".</li>
    <li>Only tag information on the album itself&#8202;&mdash;&#8202;<strong>not the individual release</strong>. Tags
        such as \"<strong class='important_text'>v0</strong>\", \"<strong class='important_text'>eac</strong>\",
        \"<strong class='important_text'>vinyl</strong>\", \"<strong class='important_text'>from.what</strong>\", etc.
        are strictly forbidden. Remember that these tags will be used for other versions of the same album.</li>
    <li>Do not use \"<strong class='important_text'>hardcore</strong>\" or \"<strong
            class='important_text'>garage</strong>\". These tags are too vague as both describe two wholly unrelated
        genres. Use \"<strong class='important_text_alt'>hardcore.dance</strong>\", \"<strong
            class='important_text_alt'>hardcore.punk</strong>\", \"<strong
            class='important_text_alt'>garage.rock</strong>\" or \"<strong
            class='important_text_alt'>garage.house</strong>\" instead.</li>
