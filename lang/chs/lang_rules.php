...
$lang_rules = array(
    ...
    'info' => "注释",
    'golden_rules' => "黄金规则",
    'golden_rules_used' => "黄金规则适用于 GreatPosterWall 和我们的社交网络。这是最高级的规则，如不遵守，你的账号将会遭受最严厉的惩罚。",
    'short_11' => "禁止重复注册。",
    'long_11' => "每位用户终生仅允许拥有一个账号，如果你的账号被禁，你可以通过 <a href=\"https://t.me/joinchat/If6Vp8_nO7lmY2Jl\" target='_blank'>Telegram 官方群</a>或 ${staffpm} 联系管理员。不要创建多个账号（即俗称的 “马甲”）。一经查实所有关联账号都将被封禁。",
    'short_12' => "禁止交易、出售、赠与或提供账号。",
    'long_12' => "如果你想要封存账号，可以通过 ${staffpm} 联系管理员来停用你的账号。",
    'short_13' => "禁止共享账号。",
    'long_13' => "账号仅供私人使用。禁止以任何方式（例如共享登录信息、外部程序等）将你的账号访问权限授予他人。如果你的亲朋好友想要使用本站，请 <a href=\"wiki.php?action=article&name=invite\">邀请</a> 或引导他们加入我们的 <a href=\"https://t.me/joinchat/If6Vp8_nO7lmY2Jl\" target='_blank'>Telegram 官方群</a>。",
    ...
    'short_24' => "禁止公开泄露站点信息",
    'long_24' => "不要在任何公共区域泄露站点真实名称和简称（可用海豹、海豹影视替代）、服务器地址以及 Tracker 地址，截图时请遮蔽站点 Logo。",
    'short_31' => "禁止参与分享率作弊。",
    ...
    'short_43' => "尊重管理组的决定。",
    'long_43' => "只允许与 Moderator 私下讨论分歧。如果 Moderator 已退休或联系不上，你可以 ${staffpm}。不允许因个人理由联系多位 Moderator；但是，如果你需要第三方意见，可以联系 Administrator。联系管理员的方式包括私信、${staffpm} 和<a href=\"https://t.me/joinchat/If6Vp8_nO7lmY2Jl\" target='_blank'>Telegram 官方群</a>。",
    'short_44' => "禁止冒充工作人员。",
    ...
    'long_51' => "禁止通过公用或免费的代理、VPN、Tor 浏览网站，你可以通过付费 VPN、私有服务器（盒子）和代理来浏览网站。不允许通过 Tor 网络访问站点或连接 Tracker 服务器。最多允许 3 个 IP 同时做种。如有疑问请发送 ${staffpm}。<i style=\"color: #ed5454\">Update! 2021-06-23</i>",
    'short_52' => "禁止滥用自动访问网站。",
    ...
    'collages_title' => "合集",
    'collages_summary' => "<li>合集的用途并非记录某个导演或演员的所有影视作品。因为我们已经为艺术家提供了单独的页面来跟踪记录这些信息。</li>
    ...
    'upload_h12k_note' => "
                ...
                <li id='r1.2.14'><a href='#h1.2'><strong></strong></a> <a href='#r1.2.14'>1.2.14.</a>
                    <strong>特别禁止内容：</strong>不允许发布任何罗列在我们 <a><a href='torrents.php?action=do_not_upload_movie_list'>黑名单</a></s>（建设中）上的内容。<strong>禁止广告内容</strong>（包括但不限于封装时在视频音频标题处写入的推广链接、种子说明内包含的大尺寸推广图等）。<i style=\"color: #ed5454\">Update! 2021-08-06</i>
                </li>",
    ...
    'upload_h21k_note' => "<ul>
                ...
                <li id='r2.1.3'><a href='#h2.1'><strong></strong></a> <a href='#r2.1.3'>2.1.3.</a> <strong>保持文件夹内文件尽可能简洁。</strong>不要包含：样片、截图、desktop.ini/thumbs.db 文件或其他任何与你要发布的内容不完全相关的东西。与复制过程相关的文件允许放在 DVD/BD 的目录结构中。考虑到辅种的便利性，请不要在种子内包含字幕文件，而是 <a href='https://greatposterwall.com/subtitles.php'>单独上传</a>。
                </li>
                <li id='r2.1.4'><a href='#h2.1'><strong></strong></a> <a href='#r2.1.4'>2.1.4.</a> <strong>DVD 和 BD 文件目录结构不允许改动，仅顶层文件夹允许重命名。</strong>
                </li>
            </ul>",
    'upload_h22k_note' => "<ul>
                <li id='r2.2.1'><a href='#h2.2'><strong></strong></a> <a href='#r2.2.1'>2.2.1.</a> <strong>截图：在发布页面的 “种子描述” 中，要求至少三张与影片分辨率相同的 PNG 格式的截图。截图应存放在 <a href='https://greatposterwall.com/upload.php?action=image'>官方图床</a>。</strong>作为替代品，使用 <a href='https://ptpimg.me'>https://ptpimg.me</a>、<a href='https://pixhost.to'>https://pixhost.to</a>、<a href='https://malzo.com'>https://malzo.com</a>、<a href='https://imgbox.com'>https://imgbox.com</a> 或 <a href='https://img.pterclub.com'>猫站</a> 图床的外链也是允许的。对于剧集类种子，你需要为每一集各提供至少一张截图。
                </li>
    ...
    'upload_h24k_note' => "
            <ul>
                ...
                <li id='r2.4.6'><a href='#h2.4'><strong></strong></a> <a href='#r2.4.6'>2.4.6.</a> <strong>你给电影添加的标签应是客观的描述。</strong>IMDb 标签是权威的，而不可靠的（主观的、有政治倾向的）标签则会被删除。标签应用于标志宽泛的类型（例如 drama 或 sci.fi），而非具体的已经有记录或更适用于合集的东西（例如 steven.spielberg、korean、imdb.top.250）。
                </li>
    ...
    'upload_h33k_note' => "
            <ul>
                ...
                <li id='r3.3.3'><a href='#h3.3'><strong></strong></a> <a href='#r3.3.3'>3.3.3.</a> <strong>超高清 Encode 必须使用 x265 编码和 MKV 容器。Web 源超高清 SDR 允许使用 x264 编码。</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
                <ul>
    ...
    'upload_h36k_note' => "
            <ul>
                ...
                <li id='r3.6.5'><a href='#h3.6'><strong></strong></a> <a href='#r3.6.5'>3.6.5.</a> <strong>对于单文件电影，请直接上传单个的字幕文件，不要将同一部电影的不同语种字幕文件一同打包上传。</strong>如，在一个压缩包内同时囊括简中、繁中、中英，这是不允许的，你应将它们分别上传。<strong>对于迷你剧，则可以将每一集对应的字幕合并打包上传。</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
                </li>
            </ul>",


    'upload_h40k_note' => "<ul>
        <li id='r4.0.1'><a href='#h4.0'><strong></strong></a> <a href='#r4.0.1'>4.0.1.</a> <strong>下面是在无特殊版本的情况下，一部影视作品的完整槽位（种子发布到站点后能占据的空余坑位，一旦占满，后来者就必须针对现有种子发起替代）表：</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
        <table border='1' id='slot_table'>
            <tr>
                <th style='width: 45px'>内容</th>
                <th style='width: 85px'>槽位类型</th>
                <th style='width: 160px'>字幕要求</th>
                <th>编码</th>
                <th style='width: 170px'>按清晰度划分</th>
                <th>说明</th>
            </tr>
            
            <tr>
                <td rowspan='11'>影片主体</td>
                <td rowspan='2'>Encode<br/>中字质量槽</td>
                <td rowspan='2'>必须内封中字<br/>(硬字、外挂不算)</td>
                <td>x264</td>
                <td>SD / 720p / 1080p (3 槽)</td>
                <td rowspan='4'>替代优先级：视频质量佳 > 体积小</td>
            </tr>
            <tr>
                <td>x265</td>
                <td>HDR 1080p / 2160p (2 槽)</td>
            </tr>
            <tr>
                <td rowspan='2'>Encode<br/>英字质量槽</td>
                <td rowspan='2'>必须带英字<br/>(可封可挂，硬字不算)</td>
                <td>x264</td>
                <td>SD / 720p / 1080p (3 槽)</td>
            </tr>
            <tr>
            ...
            <tr>
                <td rowspan='2'>Encode<br/>存档槽</td>
                <td rowspan='2'>无要求</td>
                <td>x264</td>
                <td>720p / 1080p (2 槽)</td>
                <td rowspan='2'>替代优先级：同体积更高质量优先，同质量更小体积优先</td>
            </tr>
            <tr>
                <td>x265</td>
                <td>2160p (1 槽)</td>
            ...
            <tr>
                <td rowspan='2'>Encode<br/>特色槽</td>
                <td rowspan='2'>必须内封中字或带国配<br/>(硬字、外挂不算)</td>
                <td>x264</td>
                <td>720p / 1080p (2 槽)</td>
                <td rowspan='2'>替代优先级：国配／特效字幕丰富 > 国配／特效字幕质量佳 > 视频质量优<br/>仅限外语片，单独包含特效或国配无法替代另一种</td>
            </tr>
            <tr>
                <td>x265</td>
                <td>2160p (1 槽)</td>
            ...
            <tr>
                ...
                <td>无要求</td>
                <td>-</td>
                <td>720p / 1080p / 2160p (3 槽)</td>
                <td>替代优先级：原盘质量优 > 带内封中</td>
            </tr>
            <tr>
                <td>原盘槽</td>
                <td>无要求</td>
                <td>-</td>
                <td>SD×2 / 720p / 1080p / 2160p (5 槽)</td>
                <td>替代优先级：原盘质量优<br/>蓝光原盘可以 ISO 镜像或文件夹的形式发布</td>
            </tr>
            <tr>
                <td>DIY 原盘槽</td>
                <td>无要求</td>
                <td>-</td>
                <td>1080p / 2160p (2 槽)</td>
                <td>替代优先级：国配／特效字幕更丰富 > 国配／特效字幕质量更佳 > 视频质量更优<br/>仅限外语片，单独包含特效或国配无法替代另一种，可以 ISO 镜像和文件夹的形式发布</td>
            </tr>
            <tr>
                <td rowspan='2'>附加内容</td>
                <td rowspan='2'>Encode<br/>质量槽</td>
                <td rowspan='2'>无要求</td>
                <td>x264</td>
                <td>SD / 720p / 1080p (3 槽)</td>
                <td rowspan='2'>替代优先级：视频质量佳 > 体积小</td>
            </tr>
            <tr>
                <td>x265</td>
                <td>2160p (1 槽)</td>
        ...
        <li id='r4.0.2'><a href='#h4.0'><strong></strong></a> <a href='#r4.0.2'>4.0.2.</a> <strong>槽位类型：</strong>指示了该槽位所容纳资源的类型并方便称呼和记忆，依据种子的处理、字幕、音轨情况划分。
            <ul>
                ...
                <li id='r4.0.2.3'><a href='#r4.0.2'><strong></strong></a> <a href='#r4.0.2.3'>4.0.2.3.</a> 进入 <strong>“英字质量槽”</strong> 的种子，非英语电影<strong>必须</strong>内封或外挂英字，并推荐将英字设为默认字幕。通常，种子组的首个无字幕种子会进入该槽位，如果其是非英语电影则会被标记为 “可替代”，更多请看 <a href='#r5.4.14'>5.4.14</a> 。<i style=\"color: #ed5454\">Update! 2021-08-06</i>
                </li>
            </ul>
        </li>
    ...
    'upload_h41k_note' => "
            <ul>
                <li id='r4.1.1'><a href='#h4.1'><strong></strong></a> <a href='#r4.1.1'>4.1.1.</a> <strong>对于给定电影，提供 1 个英字质量槽，1 个中字质量槽，共计 2 个 x264 Encode 槽位。</strong><i style=\"color: #ed5454\">New! 2021-08-06</i>
                </li>
    ...
    'upload_h46k_note' => "
            <ul>
                <li id='r4.6.1'><a href='#h4.6'><strong></strong></a> <a href='#r4.6.1'>4.6.1.</a> <strong>允许电影的每种剪辑版本（影院／导演、限制级／未分级……）拥有一组独立的槽位。另外，各类 HDR 格式各自拥有一组独立的槽位。</strong><i style=\"color: #ed5454\">Update! 2021-08-06</i>
                </li>
                <li id='r4.6.2'><a href='#h4.6'><strong></strong></a> <a href='#r4.6.2'>4.6.2.</a> <strong>外语电影（不包括粤语等方言电影）的国语配音种子（同时包含原声和配音音轨更好）进入特色槽。</strong>
                </li>
				<li id='r4.6.3'><a href='#h4.6'><strong></strong></a> <a href='#r4.6.3'>4.6.3.</a> <strong>非英语电影的英配种子（双音轨更好）可拥有一个额外的英字质量槽。</strong>即使英配电影的内封字幕情况符合中字质量槽标准，它也优先进入英字质量槽。 <strong>方言影片如果不包含国配或英配则可拥有一个额外的中字质量槽。</strong>即使内封字幕情况符合英字槽条件，它也优先进入中字质量槽。<i style=\"color: #ed5454\">Update! 2021-08-14</i>
                </li>
                <li id='r4.6.4'><a href='#h4.6'><strong></strong></a> <a href='#r4.6.4'>4.6.4.</a> <strong>虽然对于给定电影，每个种子都应源自被视为最佳的版本，但可以额外提供给源自稍差但提供了不同观赏体验版本的种子一组槽位。</strong>该槽位组通常由每个分辨率的一个 Encode、一个 Remux 和一个完整的原盘组成（这里没有存档槽）。如果你不确定能否共存，请移步 <a href='forums.php?action=viewthread&threadid=21'>我能发布它吗</a>。<i style=\"color: #ed5454\">Update! 2021-08-14</i>
                </li>
            </ul>",
            ...
            <ul>
                <li id='r5.2.1'><a href='#h5.2'><strong></strong></a> <a href='#r5.2.1'>5.2.1.</a> <strong>任何未满足 <a href='#h3'>相关规则</a> 定义的首选格式的种子都可被符合推荐格式的种子替代，只要其质量同等或更优。</strong>
                    <ul>
						...
						<li id='r5.2.1.2'><a href='#r5.2.1'><strong></strong></a> <a href='#r5.2.1.2'>5.2.1.2.</a> <strong>杜比视界 Remux 和国内流媒体的 WEB-DL，这两者可以 MP4 容器的形式存在，不会被其他种子以 “使用 MKV 容器” 为由替代。</strong><i style=\"color: #ed5454\">New! 2021-08-14</i>
                        </li>
                    </ul>
                </li>
    ...
    'upload_h54k_note' => "<ul>
                ...
                <li id='r5.4.3'><a href='#h5.4'><strong></strong></a> <a href='#r5.4.3'>5.4.3.</a> <strong>无谓高码（臃肿）：</strong>种子的视频或音频比特率过高。音频比特率上限手册： <i style=\"color: #ed5454\">Update! 2021-08-06</i>
                <table border='1'>
                <tr>
                ...
                <li id='r5.4.16'><a href='#h5.4'><strong></strong></a> <a href='#r5.4.16'>5.4.16.</a> <strong>无原声音轨：</strong>一部影片在同时没有原声音轨、国语配音和英语配音的情况下（仅包含小语种配音）适用此标记。<i style=\"color: #ed5454\">Update! 2021-08-14</i>
                </li>
    ...
    'tags_title' => "标签",
    'tags_summary' => "
        <li>标签应以英文逗号（ “,” ）分隔，你应使用英文点号（ “.” ）来分隔标签内的单词——例如 “<strong class='important_text_alt'>sci.fi</strong>”。</li>

        <li>请使用 <a href='upload.php' target='_blank'>左侧文本框的官方标签</a>，而不是 “非官方” 标签（例如使用官方的 “<strong class='important_text_alt'>drama</strong>” 标签，而不是非官方的  “<strong class='important_text'>holy.crap</strong>” 标签）。<strong>请注意 “<strong class='important_text_alt'>2000s</strong>” 表示 2000 到 2009 之间。</strong></li>

        <li>不要添加 “无用” 的标签，如 “<strong class='important_text'>seen.live</strong>” 、 “<strong class='important_text'>awesome</strong>” 、 “<strong class='important_text'>kung.fu</strong>” （包含在 “<strong class='important_text_alt'>action</strong>” ）等。如果是现场表演，你可以添加 “<strong class='important_text_alt'>live</strong>”。</li>

        <li>仅添加电影本身的信息，而不是某个具体版本的信息</strong>。严禁使用 “<strong class='important_text'>remux</strong>” 、 “<strong class='important_text'>encode</strong>” 、 “<strong class='important_text'>blu.ray</strong>” 、 “<strong class='important_text'>eac3to</strong>” 等。请记住，他们仅用以标明同一电影的其他版本，本身并非标签。</li>

        <li><strong>如果你对 <a href='upload.php'>左侧文本框的官方标签</a> 有疑问，那就不要添加进去。</strong></li>",
    'tags_summary_onupload' => "
    <li>标签应以英文逗号（ “,” ）分隔，你应使用英文点号（ “.” ）来分隔标签内的单词——例如 “<strong class='important_text_alt'>sci.fi</strong>”。</li>

    <li>请使用<a href='upload.php'>左侧文本框的官方标签</a>，而不是 “非官方” 标签（例如使用官方的 “<strong class='important_text_alt'>drama</strong>” 标签，而不是非官方的  “<strong class='important_text'>holy.crap</strong>” 标签）。<strong>请注意 “<strong class='important_text_alt'>2000s</strong>” 表示 2000 到 2009 之间。</strong></li>
